 ...
 * @author Clayd Nandza
 */
public class InternalDado extends javax.swing.JInternalFrame {
    private int pontos = 0;

    /**
     * Creates new form NewInternalDado
     */
    public InternalDado() {
        initComponents();
    ...
    private void initComponents() {
        ...
        boxNivel.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Basico", "Medio", "Tecnico Profissional", "Superior" }));
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
     ...
     private void preencherBoxCurso(){
        ...
        boxCurso.addItem(null);
    
        for (AreaFormacao areaformacao: lista){
                boxCurso.addItem(areaformacao.toString());
        } 
    }
     ...
     public void limpar(){
        ...
        checkPortugues.setSelected(false);
        checkIngles.setSelected(false);
        checkOutros.setSelected(false);
        checkChangana.setSelected(false);
    }
